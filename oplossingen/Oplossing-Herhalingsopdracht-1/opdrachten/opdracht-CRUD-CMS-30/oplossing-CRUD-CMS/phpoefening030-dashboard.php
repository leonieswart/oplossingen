...
$dump = '';
	...
	if (isset($_COOKIE['login'])) {
			...
			if (md5($email . $salt) == $hashedEmail) {
				...
				$dump .= 'Ingelogd als ' . $email . ' | <a href="phpoefening030-logout.php">uitloggen</a>';
				
				$dump .= '<ul>';
				$dump .= '<li><a href="phpoefening030-artikels-overzicht.php">Artikels</a></li>';
				$dump .= '<li><a href="phpoefening030-gebruikers-details-overzicht.php">Gegevens wijzigen</a></li>';
				
				if ($userTypeResult['user_type'] == 0 || $userTypeResult['user_type'] == 1) {
				
					$dump .= '<li><a href="phpoefening030-gebruikers-details-overzicht.php">Overzicht van gebruikers</a></li>';
