...
<html>
    ...
    <section class="body">
        ...
        <h1 class="extra">Opdracht cookies: deel 2</h1>

        <ul>
            <li>Zorg voor een "mij onthouden" checkbox in het invulformulier:
            ...
            <li>Wanneer dit aangevinkt is, heeft de cookie een expiration date van 30 dagen</li>
            <li>Wanneer dit niet aangevinkt is, vervalt de cookie na het beëindigen van de sessie</li>
        </ul>

         <h1 class="extra">Opdracht cookies: deel 3</h1>
         
         <ul>
             <li>Zorg ervoor dat er een persoonlijke begroeting verschijnt wanneer er is ingelogd. (bv. "Hallo Jan, welkom terug!")
